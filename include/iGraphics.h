...
int iSetTimer(int msec, void (*f)(void))
{
    ...
    if(iAnimCount == 0) SetTimer(0, 0, msec, (TIMERPROC)iA0);
    if(iAnimCount == 1) SetTimer(0, 0, msec, (TIMERPROC)iA1);
    if(iAnimCount == 2) SetTimer(0, 0, msec, (TIMERPROC)iA2);
    if(iAnimCount == 3) SetTimer(0, 0, msec, (TIMERPROC)iA3);
    if(iAnimCount == 4) SetTimer(0, 0, msec, (TIMERPROC)iA4);
    if(iAnimCount == 5) SetTimer(0, 0, msec, (TIMERPROC)iA5);
    if(iAnimCount == 6) SetTimer(0, 0, msec, (TIMERPROC)iA6);
    if(iAnimCount == 7) SetTimer(0, 0, msec, (TIMERPROC)iA7);
    if(iAnimCount == 8) SetTimer(0, 0, msec, (TIMERPROC)iA8);
    if(iAnimCount == 9) SetTimer(0, 0, msec, (TIMERPROC)iA9);
